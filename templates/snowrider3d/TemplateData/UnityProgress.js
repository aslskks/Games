...
function UnityProgress(gameInstance, progress) {
    ...
    {
        gameInstance.textProgress.innerHTML = '100% - Running, Wait..' +' <img src="' + "snowrider3d/" + rootPath + '/gears.gif" class="spinner" />';
        gameInstance.progress.style.display = 'none';
    }
    else
    {
        gameInstance.textProgress.innerHTML = 'Loading - ' + Math.floor(progress * 100) + '%' + ' <img src="' + 'snowrider3d/' + rootPath + '/gears.gif" class="spinner" />';
    }

    /*
    if (progress == 1) {
        gameInstance.textProgress.innerHTML = 'Running, Please Wait.. <img src="' + "snowrider3d/" + rootPath + '/gears.gif" class="spinner" />';
        gameInstance.progress.style.display = 'none';
    }
    */
