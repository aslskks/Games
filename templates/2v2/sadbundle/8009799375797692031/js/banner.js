...
Banner.prototype.onVisible = function () {
  var _this2 = this;
  this.politeLoad(['https://s0.2mdn.net/creatives/assets/2474893/webfont.js', 'https://s0.2mdn.net/ads/studio/cached_libs/gsap_3.11.1_min.js', 'https://unpkg.com/split-type'], function () {
    WebFont.load({
      // custom: {
      //   families: ['Circe-Light:350','Circe-Regular:400','Circe-Bold:700']
      // }
      google: {
        families: ['DM Sans:400', 'DM Sans:700']
      }
    });
    _this2.start();
  });
